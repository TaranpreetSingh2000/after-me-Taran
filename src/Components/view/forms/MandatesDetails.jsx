...
const MandatesDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    fetchData(
      "http://localhost:8090/api/v1/ecsMandateDetails",
      dataWithUserId,
      trimmedcardtitle
    );
  };
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-row row my-2 my-2">
              <div className="form-group col-md-6">
                <Label htmlFor="ecsfavouring" label="ECS Favouring" />
                ...
                <Input
                  ...
                  onChange={handleChange}
                  errorMessage={validationErrors.ecsFavouring}
              ...
              <div className="form-group col-md-6">
                <Label htmlFor="amount" label="Amount(Rs) Periodically" />
                <span className="text-danger px-2">*</span>
                <Input
                  type="number"
                  name="amount"
            ...
            <div className="form-row row my-2">
              <div className="form-group col-md-6">
                <Label htmlFor="ecsstartdate" label="ECS Start Date" />
                <span className="text-danger px-2">*</span>
                <Input
                  type="date"
                  name="ecsStartDate"
              ...
              <div className="form-group col-md-6">
                <Label htmlFor="ecsenddate" label="ECS End Date" />
                <span className="text-danger px-2">*</span>
                <Input
                  type="date"
                  name="ecsEndDate"
