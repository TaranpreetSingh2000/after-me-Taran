...
const ProvidentFund = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    fetchData(
      "http://localhost:8090/api/v1/public-provident-fund",
      dataWithUserId,
      trimmedcardtitle
    );
  };
        ...
        <div className="container my-5">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-row row my-2 my-2">
              ...
              <div className="form-group col-md-6">
                <Label htmlFor="ppfAccountNumber" label=" PPF Account number" />
                <span className="text-danger px-2">*</span>
                <Input
                  type="number"
            ...
            <div className="form-row row my-2">
              <div className="form-group col-md-6">
                <Label htmlFor="maturitydate" label="Maturity Date" />
                <span className="text-danger px-2">*</span>
                <Input
                  type="date"
                  name="maturityDate"
