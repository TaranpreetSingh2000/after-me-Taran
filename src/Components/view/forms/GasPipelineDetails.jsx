...
const GasPipelineDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    fetchData(
      "http://localhost:8090/api/v1/gas-pipeline",
      dataWithUserId,
      trimmedcardtitle
    );
  };
  return (
    <>
      ...
      <div className="gaspipelinedetails">
        <div className="container my-5">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-row row my-2 my-2">
              ...
              <div className="form-group col-md-6">
                <Label htmlFor="routeno" label="Route Number" />
                <Input
                  type="number"
                  name="routeNum"
                  className="form-control"
            ...
            <div className="form-row row my-2">
              ...
              <div className="form-group col-md-6">
                <Label htmlFor="khatano" label="Khata Number" />
                <Input
                  type="number"
                  name="khataNum"
                  className="form-control"
