    ...
    <>
      ...
      <div className="form-row row my-2 my-2">
        <div className="form-group col-md-6">
          <Label htmlFor="name" label="Name (As mention in the Pan card)" />
        ...
        <div className="form-group col-md-6">
          <Label htmlFor="pancardno" label="Pancard No" />
          <span className="text-danger px-2">*</span>
          <Input
            type="text"
            name="panCardNumber"
            ...
            className="form-control"
            onChange={handleChange}
            errorMessage={validationErrors.panCardNumber}
            errorClassName="is-invalid"
            required={true}
          />
        </div>
...
export default CommonPanDetails;
